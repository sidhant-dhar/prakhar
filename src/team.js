        ...
        return (
            <div className = 'text-center team-wrapper mt-lg-5 mt-3'>
                ...
                <Row className = 'w-75 mx-auto mt-4'>
                    ...
                    <Row>
                    <Col className = 'col-12'><img src = { nirmohi } alt = 'team member: Nirmohi' className = 'img-fluid'/></Col>
                ...
                <Col className = 'col-md-4 col-12'>
                    <Row>
                    <Col className = 'col-12'><img src = {jnbaliya} alt = 'team member: JN Baliya' className = 'img-fluid'/></Col>
                    <Col className = 'col-12 text-left team-member mb-4'>
